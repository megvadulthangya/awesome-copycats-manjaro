...
REPO_PKGS=(
  ...
  wavemon network-manager-applet feh qt6ct raw-thumbnailer geany ttf-firacode-nerd
  fish starship bat eza jq
)
...
# --- AUR csomagok ---
AUR_PKGS=(
  lain-git awesome-git awesome-freedesktop-git tilix-git tamzen-font 
  i3lock-fancy-git grayjay-bin betterlockscreen nordic-theme nordic-darker-theme 
  nordic-darker-standard-buttons-theme nordic-polar-standard-buttons-theme 
  nordic-standard-buttons-theme nordic-bluish-accent-theme nordic-bluish-accent-standard-buttons-theme 
  geany-nord-theme nordzy-icon-theme nordic-wallpapers oh-my-posh-bin
  fish-done find-the-command
)
